...
/*   function checkUpdate(force = false) {
  ...
  const [shouldShowSubscriptionModal, setShowSubscriptionModal] = useState(false);
...
{/*           <ListItem
      ...
      <List>
            ...
            <IconButton
              icon={<EditIcon />}
              text={Locale.Settings.Subscription.SignIn} 
              onClick={() => setShowSubscriptionModal(true)}
              // disabled={subscription?(subscription.status==='active'?true:false):false}
             />
...
{/*
        ...
        <List>
          <ListItem
              ...
              subTitle = {Locale.Settings.About.SubTitle}
            >
